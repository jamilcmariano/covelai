...
import { evaluateCoverLetter, generateFallbackEvaluation, type LetterEvaluationRequest } from "@/lib/gemini-service"
...
export async function POST(request: Request) {
  try {
    ...
    const isFallback =
      ...
      (evaluation.score === fallbackEvaluation.score && evaluation.feedback === fallbackEvaluation.feedback)
    ...
    return NextResponse.json({ error: "Failed to evaluate cover letter" }, { status: 500 })
  }
}
